  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="text-center mb-6">
        ...
        <h2 className="text-xl font-semibold">{profile?.name || profile?.full_name || '用户'}</h2>
        <p className="text-gray-500">客户编号: {profile?.customer_number || profile?.id || 'N/A'}</p>
      </div>
      
      <div className="border-t pt-6">
        <h3 className="text-lg font-semibold mb-4">账户管理</h3>
